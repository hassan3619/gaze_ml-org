...
def __getstate__(self):
        ...
        return {
            ...
            'min_after_dequeue': self._preprocess_queue.min_after_dequeue,
            'fread_queue_capacity': self._fread_queue_capacity,
            'preprocess_queue_capacity': self._preprocess_queue_capacity,
...
def __setstate__(self, state):
        ...
        self.__init__(
            tensorflow_session=state['tensorflow_session'],
            data_format=state['data_format'],
            batch_size=state['batch_size'],
            num_threads=state['num_threads'],
            min_after_dequeue=state['min_after_dequeue'],
            fread_queue_capacity=state['fread_queue_capacity'],
            preprocess_queue_capacity=state['preprocess_queue_capacity'],
